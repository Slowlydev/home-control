	...
	return (
		<SSRProvider>
			<Provider theme={theme} UNSAFE_style={{ background: "none" }}>
				<ColorSlider channel="red" value={currentColor} onChange={setCurrentColor} />
				<ColorSlider channel="green" value={currentColor} onChange={setCurrentColor} />
				<ColorSlider channel="blue" value={currentColor} onChange={setCurrentColor} />
			</Provider>
		</SSRProvider>
	);
}
