  ...
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <div
          className={`${styles.dot} ${!hasNoUpdates ? styles.error : void 0}`}
        />
        <p>Updates</p>
      </div>
      ...
      <div className={styles.wrapper}>
        <div
          className={`${styles.dot} ${!hasInternet ? styles.error : void 0}`}
        />
        <p>Internet</p>
      </div>
      ...
      <div className={styles.wrapper}>
        <div
          className={`${styles.dot} ${
            !hasConnectivity ? styles.error : void 0
          }`}
        />
        <p>Connectivity</p>
      </div>
